...
import { Heart, MessageCircle, MoreVertical, MapPin, Eye, Gift, Star, Sparkles, Filter, Flame, Zap, Camera, UserCheck, UserPlus, CheckCircle, ChevronLeft, ChevronRight, X } from 'lucide-react';
...
export default function HomePage() {
  ...
  const handleViewProfile = (postId: string, personaId: string) => {
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5">
                      <div className="flex items-center justify-between mb-4 sm:mb-5">
                        ...
                        {/* View Profile Button */}
                        <button
                          onClick={() => handleViewProfile(post.id, post.personaId)}
                ...
                <div className="space-y-4">
                  {suggestedPeople.map((person, index) => (
                    <div key={`suggestion-${person.id}-${index}`} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                      ...
                      <button 
                        onClick={() => handleChat(person.personaId)}
